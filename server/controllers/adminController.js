...
export const getDashboard = async (req,res) => {
    try {
        ...
        // avoiding waterfall execution and significantly reducing total response time.
        // Also using .lean() for recentBlogs to bypass document hydration since data is only read.
