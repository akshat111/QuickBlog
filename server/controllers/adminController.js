...
export const getDashboard = async (req,res) => {
    try {
        ...
        // which prevents waterfall execution and significantly reduces the total response time.
        // Also added .lean() to recentBlogs query to bypass Mongoose document hydration.
