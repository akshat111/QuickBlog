...
export const addBlog = async (req,res)=> {
    try {
        ...
        // Replaced synchronous fs.readFileSync with async fs.promises.readFile.
        // This prevents event loop starvation during disk I/O, improving server responsiveness under load.
