...
const BlogList = () => {
  ...
  // Replaced multiple filter passes with a single pass and memoized the result.
  // We also calculate input.toLowerCase() once outside the loop instead of on every iteration.
